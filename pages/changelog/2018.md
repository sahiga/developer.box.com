...
* [cli_v2_release_notes][cli_v2_release_notes]: Major revision details, breaking
  changes, and bug fixes.
* [cli_v2_release_commands][cli_v2_release_commands]: All commands available in the new
  CLI.
...
A major update (version 2.0) of the [python_sdk_v2][python_sdk_v2] has been
released with significant updates and API feature parity completion.
[python_sdk_v2_release_notes][python_sdk_v2_release_notes] for full API release notes. Along with
...
`sendRequest` that accepts an [salesforce_sdk_httprequest][salesforce_sdk_httprequest]`HttpRequest`[salesforce_sdk_httprequest][salesforce_sdk_httprequest]
object as a parameter and returns an
[salesforce_sdk_httpresponse][salesforce_sdk_httpresponse]`HttpResponse`[salesforce_sdk_httpresponse][salesforce_sdk_httpresponse]
...
We have expanded the capabilities of [box_relay][box_relay], a workflow tool
...
[box_relay_announce][box_relay_announce].
...
31, 2018. More information can be found [platform_activity_csv][platform_activity_csv].
...
* **[New Multizones commandscli_update_multizones][cli_update_multizones]**New Multizones commands: Adds support for
  [cli_update_multizones_announce][cli_update_multizones_announce] for data residency.
* **[Fix for user CSV operationscli_update_csv_operations][cli_update_csv_operations]**Fix for user CSV operations: Fixes a bug that
...
* **[Ability to set `can_non_owners_invite` flag on folder updatescli_update_folder_update_flag][cli_update_folder_update_flag]**Ability to set  flag on folder updates:
    Allows setting whether non-owners can invite other users to collaborate on the
    folder.
  <!-- markdownlint-enable line-length -->
* **[New CLI configuration dump commandcli_update_config_dump][cli_update_config_dump]**New CLI configuration dump command: Adds the
...
more information, please see the [community][community].
